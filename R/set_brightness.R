...
#'
#' @param color Character value of length 1 - The color that will have its brightness set. A standard 6 digit hexadecimal webcolor like "#000000" or a valid `R` color from `colors()` is accepted.
#' @param percentage A numeric value of length 1. The percentage of which the brightness should be set. Values from 0 - 1 are accepted.
#'
...
#'
#'
set_brightness <- function(color = NULL, percentage = NULL){
  #==========================================================================#
  # Input Checks--------------------------------------------------------------
  #==========================================================================#
